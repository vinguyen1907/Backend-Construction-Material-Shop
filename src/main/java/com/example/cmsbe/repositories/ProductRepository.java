...
public interface ProductRepository extends JpaRepository<Product, Integer>, JpaSpecificationExecutor<Product> {
    Page<Product> findByOriginAndUnitPriceBetween(String origin, double minUnitPrice, double maxUnitPrice, Pageable pageable);
    long countByOriginAndUnitPriceBetween(String origin, double minUnitPrice, double maxUnitPrice);
    Page<Product> findByUnitPriceBetween(double minUnitPrice, double maxUnitPrice,  Pageable pageable);
    ...
    Page<Product> findByNameContainingAndUnitPriceBetween(String keyword, double minPrice, double maxPrice, Pageable pageable);
